        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="github" id="github"
                       placeholder="Enter your Github account" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="avatar" id="avatar" placeholder="Add your avatar"
                       required>
            </div>
            <div class="form-group">
                <label for="video">Video</label>
                <input type="text" class="form-control" name="video" id="video" placeholder="Enter your favorite video"
                       required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="quoteAuthor" id="quote-author"
                       placeholder="Type quote author" required>
            </div>
        </div>
